...
var API_KEY = "c1ee0286fd1a41a9b5c51deaf879fd0e";
var LEAGUE_ID = 2014;
    ...
    data.teams.forEach(function (tim) {
        ...
        <div class="card">
          ...
          <div class="card-action right-align">
              <a class="waves-effect waves-light btn-small grey darken-4" onclick="insertTeamListener(${tim.id}); this.onclick=null;">Tambahkan Ke Favorit</a>
          </div>
        </div>
      </div>
        `;
